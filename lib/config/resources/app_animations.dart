...
extension WidgetAnimationExtension on Widget {
  ...
  /// from top to bottom with fade

  Widget animateTopToBottom({
    Duration duration = const Duration(milliseconds: 500),
    bool isFromTop = true,
  }) {
    return animate()
  ...
  /// slide from left to right with fade

  /// wiggle horizontally like a suggestion
  ...
  /// zoom in once then stop


  Widget animateFadeInOut({
